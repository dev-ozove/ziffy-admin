...
export default function Main_prediction() {
    ...
    <div className="container">
        <div className="container mt-5">
            <form>
                ...
                <div className="mb-3 row">
                    <label  className="col-sm-4 col-form-label text-end">Team 1 name:</label>
                    <div className="col-sm-4">
                    <input type="text" className="form-control" id="" value={match.team_name_1} name="team_name_1" onChange={getMatchData}/>
                    </div>
                </div>
                <div className="mb-3 row">
                    <label  className="col-sm-4 col-form-label text-end">Team 2 name:</label>
                    <div className="col-sm-4">
                    <input type="text" className="form-control" id="" value={match.team_name_2} name="team_name_2" onChange={getMatchData}/>
                    </div>
                </div>
                <div className="mb-3 row">
